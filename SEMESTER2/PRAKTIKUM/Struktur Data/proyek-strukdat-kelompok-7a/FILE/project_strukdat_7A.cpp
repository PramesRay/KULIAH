...
void login(Tree root)
{
    ...
    do
    {
        ...
        do
        {
            if (nama == dataNama[npm - 1] && npm == dataNpm[npm - 1])
            {
                cout << "Login Berhasil!";
                loop = 4;
                break;
            ...
            {
                system("cls");
                cout << "Login Gagal! |" << loop << "x|\n" << endl;
                break;
            }

            if (cariNamaMhs(root, npm) == "noName")
            {
                system("cls");
                cout << "Login Gagal atau NPM tidak terdaftar! Harap hubungi Admin!!\n";
                break;
            }
