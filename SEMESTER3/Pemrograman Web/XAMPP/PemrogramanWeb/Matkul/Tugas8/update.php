...
<body>      
  <h1 class="text_center"> Update Biodata Mahasiswa </h1>
          ...
          <tr>
            ...
            <td>
              <input 
                  ...
                  value="L"
                  autocomplete="off">
              <label class="btn btn-outline-primary text_right" for="primary-outlined">
          ...
          <tr>
            ...
            <td>
              <input 
                  ...
                  autocomplete="off"
              >
              <label class="btn btn-outline-danger text_right" for="danger-outlined">
