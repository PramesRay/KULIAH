<?php
    ...
    if (isset($_POST['Update'])){
        $query = "UPDATE identitas SET npm=:npm, nama=:nama, email=:email, tgl_lahir=:tgl_lahir, jk=:jk, alamat=:alamat";
            ...
            <div class="row">
                <div class="col-md-5 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="email" name="email" value="<?= $result->EMAIL?>" placeholder="Email"
