...
* Deskripsi : Checked exception - UnsupportedEncodingException
* ===Kondisi===
* Terjadi ketika skema pengkodean karakter yang tidak didukung digunakan dalam string atau byte java. 
* Metode java String getBytes mengonversi string yang diminta menjadi byte dalam format pengkodean yang ditentukan. 
