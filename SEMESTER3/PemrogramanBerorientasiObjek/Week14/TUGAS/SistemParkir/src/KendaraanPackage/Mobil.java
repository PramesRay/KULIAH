...
public class Mobil extends Kendaraan{
    ...
    public Mobil(String jenis, String platKend, String namaBrand, String bpkb, String stnk) {
        super(jenis, platKend, namaBrand, bpkb, stnk);
        this.tipe = " ";
        this.pintu = 0;
    }
    public Mobil(String jenis, String platKend, String namaBrand, String bpkb, String stnk, String tipe, int pintu) {
        super(jenis, platKend, namaBrand, bpkb, stnk);
        this.tipe = tipe;
        this.pintu = pintu;
    }
